...
#I hope I don't break it even worse
...
def add_block_cluster(x, y, w, h, kind, status): 
...
def add_perimeter_blocks():
    blocks.append([75, 75, 100, 100, IS_BLUE, TOUCHED])
    # hard code the rest
...
def add_blocks(x, y, w, h): 
    ...
    for y_loc in range(y, y+h, 40):
        for x_loc in range(x, x+w, 40):
            block = [x_loc, y_loc, 30, 30, IS_BLUE, TOUCHED]
            blocks.append(block)
